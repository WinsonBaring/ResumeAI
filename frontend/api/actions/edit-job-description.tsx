...
export const editJobDescription = async (prevState: any, formData: FormData) => {
    ...
    const result = await client.from(JOB_DESCRIPTION).update([{ description: value.description }]);
